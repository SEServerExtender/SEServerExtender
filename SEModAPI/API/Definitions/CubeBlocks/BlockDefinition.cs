...
namespace SEModAPI.API.Definitions.CubeBlocks
{
	...
	public abstract class BlockDefinition : DefinitionOverLayer
	{
		...
		[Browsable(true)]
		[ReadOnly(true)]
		[Description("Get the formatted get the in-game name of the block.")]
		public string InGameName
		{
			get
			{
				return GetSubTypeDefinition().BlockPairName;
			}
		}
		...
		[Browsable(true)]
		[ReadOnly(true)]
		[Description("Formatted Name of a block.")]
		...
		[Browsable(true)]
		[ReadOnly(false)]
		[Description("Get or set the current CubeBlock build time in second.")]
		public float BuildTime
		{
			get { return GetSubTypeDefinition().BuildTimeSeconds; }
			set
			{
				if (GetSubTypeDefinition().BuildTimeSeconds.Equals(value)) return;
				GetSubTypeDefinition().BuildTimeSeconds = value;
				Changed = true;
			}
		}
		...
		public float DisassembleRatio
		{
			...
			set
			{
				if (GetSubTypeDefinition().DisassembleRatio.Equals(value)) return;
				GetSubTypeDefinition().DisassembleRatio = value;
				Changed = true;
			}
		}
		public MyObjectBuilder_CubeBlockDefinition.CubeBlockComponent[] Components
		{
			get { return GetSubTypeDefinition().Components; }
		}
		...
		[Browsable(true)]
		[ReadOnly(false)]
		[Description("Get or set if the Block uses Model intersection.")]
		public bool UseModelIntersection
		{
			get { return GetSubTypeDefinition().UseModelIntersection; }
			set
			{
				if (GetSubTypeDefinition().UseModelIntersection == value) return;
				GetSubTypeDefinition().UseModelIntersection = value;
				Changed = true;
			}
		}
